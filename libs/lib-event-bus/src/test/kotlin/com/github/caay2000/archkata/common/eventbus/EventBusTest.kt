...
internal class EventBusTest {
    ...
    @Test
    @OptIn(ExperimentalCoroutinesApi::class)
    internal fun `subscriber receive the published event`() = runTest {
    ...
    @Test
    @OptIn(ExperimentalCoroutinesApi::class)
    internal fun `multiple subscribers receive the published event`() = runTest {
    ...
    @Test
    @OptIn(ExperimentalCoroutinesApi::class)
    internal fun `subscribers receive just their requested events`() = runTest {
        val stringSubscriber = StringSubscriber()

...
import com.github.caay2000.librarykata.context.book.mother.LoanDocumentMother.toLoanDocument
...
class SearchLoanControllerTest {
    ...
    fun `a user without loans has no loans`() = testApplication {
        ...
        testUseCases.`search all loans by UserId`(UserId(account.id.value))

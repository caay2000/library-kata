...
import com.github.caay2000.librarykata.hexagonal.context.primaryadapter.http.serialization.toLoanDocumentIncludedResource
...
class AccountToAccountDocumentTransformer(loanRepository: LoanRepository) : Transfomer<Account, AccountDocument> {
    ...
    override fun invoke(value: Account, includes: List<String>): AccountDocument {
        ...
        return AccountDocument(
            data = value.toAccountDocumentResource(loans),
            included = includes.shouldProcess(FindAccountController.Included.LOANS) {
                loans.toLoanDocumentIncludedResource()
            },
        )
    }
}
